      ...
      <div className="max-w-5xl mx-auto text-center z-10">
        ...
        >
          <Link to="contact" smooth duration={500} offset={-70}>
            <button className="px-8 py-3 bg-gradient-to-r from-primary to-accent rounded-full font-semibold hover:shadow-lg hover:shadow-primary/30 transition-all hover:-translate-y-1">
              Get In Touch
            </button>
          </Link>
          <a 
